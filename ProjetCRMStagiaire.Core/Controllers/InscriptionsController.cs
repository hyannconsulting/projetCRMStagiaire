...
namespace ProjetCRMStagiaire.Core.Controllers
{
    public class InscriptionsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,IdActiviteSportive,DateInscription,StagiaireId")] Inscription inscription)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,IdActiviteSportive,DateInscription,StagiaireId")] Inscription inscription)
        {
